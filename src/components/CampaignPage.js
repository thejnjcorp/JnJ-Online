...
export function CampaignPage() {
    ...
    return <div className="CampaignPage">
        ...
        <div className="CampaignPage-actions">
            ...
            <button type="button" className='CampaignPage-secondary-button' onClick={() => navigate("/campaigns/" + campaignId + "/races")}>
                Manage Races
            </button>
            <button type="button" className='CampaignPage-secondary-button' onClick={() => navigate("/campaigns/" + campaignId + "/statuses")}>
                Manage Statuses
            </button>
            {canWrite && <button type="button" className='CampaignPage-secondary-button' onClick={() => navigate("/campaigns/" + campaignId + "/encounters")}>
                Encounters
            </button>}
        </div>
