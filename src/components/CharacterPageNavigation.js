...
import { RaceVersionControl } from './RaceVersionControl';
import { ReactComponent as PersonIcon } from '../icons/person.svg';
import { ReactComponent as PencilIcon } from '../icons/pencil.svg';

// classInfo / raceInfo ({ status, latestVersion } from useClassVersion /
// useRaceVersion) are optional: without them the version controls simply
// aren't shown.
export function CharacterPageNavigation({characterPage, userId, classInfo, raceInfo}) {
